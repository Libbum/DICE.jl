...
function assign_scenario(s::OptimalPriceScenario, version::Version, model::JuMP.Model, config::Options, params::ParametersV2016, vars::VariablesV2016)
    setupperbound(vars.μ[1], config.μ₀);
end

function assign_scenario(s::Scenario, version::Version, model::JuMP.Model, config::Options, params::ParametersV2016, vars::VariablesV2016)
